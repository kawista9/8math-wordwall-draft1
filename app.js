(() => {
  ...
  const LABS = {
    ...
    "8.6A": {
      ...
      videos: [
        ...
        ["https://somup.com/cOeIezVcjUu", "Height of the Cylinder"],
        ["https://somup.com/cOeIemVcjU9", "V = B × h"],
  ...
  function skipCurrentLabProblem() {
    ...
    if (standard === "8.4A") {
      ...
      resetEquationWritingTask(data);
      renderLab85I();
    } else if (standard === "8.6A") {
      if (data.index >= CYLINDER_VOLUME_TASKS.length - 1) return showLabCompletion(standard);
      data.index += 1;
      resetCylinderVolumeTask(data);
      renderLab86A();
